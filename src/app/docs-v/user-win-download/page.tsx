...
export default function Dpage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      const fileUrl =
        "https://github.com/devplus2024/music-app/releases/download/2.3.5/DecentSetup.2.5.3.exe";
      const link = document.createElement("a");
      link.href = fileUrl;
      link.setAttribute("download", "DecentSetup.2.5.3.exe"); // Tên file sẽ tải xuống
