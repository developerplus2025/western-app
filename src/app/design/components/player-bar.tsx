      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex w-[25rem] items-center gap-[1rem]">
          ...
          >
            ...
            <Slider.Thumb className="hidden h-3 w-3 rounded-full border border-primary/50 bg-background shadow transition-colors hover:block focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
          </Slider.Root>
